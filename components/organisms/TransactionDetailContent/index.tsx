...
export default function TransactionDetailContent({ data }: TransactionDetailContentProps) {
    return (
                                ...
                                <div className="game-checkout d-flex flex-row align-items-center">
                                    <div className="pe-4">
                                        <div className="cropped">
                                            <img src={`${API_IMG}/${data.historyVoucherTopup.thumbnail}`} width="200" height="130"
