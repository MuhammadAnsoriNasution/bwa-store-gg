...
export default React.memo(function NominalItem({ _id, coinName, coinQuantity, price, onChange }: NominalItemProps) {
    return (
        <label className="col-lg-4 col-sm-6 ps-md-15 pe-md-15 pt-md-15 pb-md-15 pt-10 pb-10"
            htmlFor={_id}
            onChange={onChange}
        >
            <input className="d-none" type="radio" id={_id} name={_id} value={_id} />
            <div className="detail-card">
                ...
                <p className="text-lg color-palette-1 m-0">{formatCurrency(price)}</p>
            </div>
        </label>
    )
})